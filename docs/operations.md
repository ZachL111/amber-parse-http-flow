...
`amber-parse-http-flow` is centered on parsers work in Ruby. The technical target is: Implement a Ruby parsers project for http format conversion, using round-trip fixtures and lossless normalization checks.
